...
public enum InvestAccountErrorCode implements ErrorCode {
    ...
    ACCOUNT_NOT_ACTIVE(HttpStatus.BAD_REQUEST, "INVEST_400_005", "활성 상태의 증권계좌만 조회할 수 있습니다."),
    ACCOUNT_ACCESS_DENIED(HttpStatus.FORBIDDEN, "INVEST_403_001", "본인 계좌만 조회할 수 있습니다."),
    ACCOUNT_NOT_FOUND(HttpStatus.NOT_FOUND, "INVEST_404_001", "존재하지 않는 증권계좌입니다."),
